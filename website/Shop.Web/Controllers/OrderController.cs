...
namespace Shop.Web.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public OrderController(IOrder orderService, IGraphicPhoto GraphicPhotoService, ShoppingCart shoppingCart, UserManager<ApplicationUser> userManager)
        {
        ...
        public async Task<IActionResult> Checkout(OrderIndexModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                model.OrderTotal = items.Sum(item => item.Amount * item.GraphicPhoto.Price);
